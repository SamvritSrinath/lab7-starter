...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		//type validation
		//Jonathan mentioned that this was not necessary. 
		// if (typeof data.imgSrc !== 'string' || typeof data.imgAlt !== 'string' || typeof data.titleLnk !== 'string' || typeof data.titleTxt !== 'string' || typeof data.organization !== 'string' || typeof data.rating !== 'number' || typeof data.numRatings !== 'number' || typeof data.lengthTime !== 'string' || typeof data.ingredients !== 'string') {
		// 	console.error('Invalid data type passed to <recipe-card>.');
		// 	return;
		// }

		// A6. TODO - Select the <article> we added to the Shadow DOM in the constructor
		// used lab 6 as reference
